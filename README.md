...
| [ExcelStreamingController](src/main/java/io/github/scndry/examples/web/ExcelStreamingController.java) | Large download via `StreamingResponseBody` + row-by-row upload via `SheetMappingIterator` |
